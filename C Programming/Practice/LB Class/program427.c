...
void DeleteLast(PPNODE first , PPNODE last)
{
   ...
   else
   {
      ...
      free(*last);    //last cha node udavla
      *last = temp; //ani atta temp 300 la yrun thamblay condition mule mhnun *last la temp dilay node 4 notya 400 ha last node hota toh udavla  ani nantar to udavlyavr 8last = temp manje last chya node madhe 300 dila
